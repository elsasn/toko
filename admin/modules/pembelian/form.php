        ...
        <form role="form" class="form-horizontal" action="modules/pembelian/proses1.php?act=insert" method="POST" name="formpembelian">
          <div class="box-body">
           ...
           <div class="form-group">
            ...
            <table id="table-striped" class="table table-bordered table-striped table-hover">
              <div>
                
              <a href="?module=pembelian" class="btn btn-default btn-reset">Tambah</a>
              </div>
            <thead>
              <tr>
        ...
        <form role="form" class="form-horizontal" action="modules/pembelian/proses.php?act=update" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">ID pembelian</label>
              <div class="col-sm-5">
                <select class="chosen-select" name="id_pembelian" data-placeholder="-- Pilih pembelian --" onchange="tampil_pembelian(this)" autocomplete="off" required>
                  <option value=""></option>
                  <?php
                  $query_pembelian = mysqli_query($mysqli, "SELECT id_pembelian, nama_pembelian FROM data_pembelian ORDER BY nama_pembelian ASC")
                  ...
                  echo"<option value=\"$data_pembelian[id_pembelian]\"> $data_pembelian[id_pembelian] | $data_pembelian[nama_pembelian] </option>";
                  }
                  ?>
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="chosen-select" id="id_jadwal" name="id_jadwal" data-placeholder="-- Pilih Jadwal --"  autocomplete="off" required>
                  <option value=""></option>
                  <?php
                  $query_pembelian = mysqli_query($mysqli, "SELECT id_jadwal, nama_jurusan FROM jadwal ORDER BY nama_jurusan ASC")
                  or die('Ada kesalahan pada query tampil jadwal: '.mysqli_error($mysqli));
                  while ($data_jadwal = mysqli_fetch_assoc($query_pembelian)) {
