      ...
      <form role="form" class="form-horizontal" action="modules/pembatalan/proses.php?act=insert" method="POST" name="formpembatalan">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="date" class="form-control" id="tgl_transaksi"  name="tgl_transaksi" value="<?php echo $tgl_transaksi  ?>"  required readonly>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="date" class="form-control" id="tgl_berangkat"  name="tgl_berangkat" value="<?php echo $tgl_berangkat ?>"  required readonly>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Jumlah Tiket Tersisa</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="jumlah_tiket_tersisa"  name="jumlah_tiket_tersisa" on
                keyup="tiket()"  required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="submit" class="btn btn-primary btn-submit disabled" disabled="disabled" 
                  id="btn-simpan" name="simpan" value="Simpan">
...
<!-- Optional JavaScript -->
      ...
      h2=jumlah_tiket;
      jumlah_tiket_tersisa=(h2-jumlah_tiket_kembali);
      $("#jumlah_tiket_tersisa").val(jumlah_tiket_tersisa);
      ...
      $("#harga, #jumlah_tiket, #jumlah_tiket_tersisa").keyup(function() {
      hitung();
      });
