            ...
            <table width="50%" border="0.3" cellpadding="0" align="center" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="25" align="center" valign="middle">Jumlah Bayar</th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
           ...
           // $harga_jual = format_rupiah($data['harga_jual']);
            ...
            echo "  <tr>
                        ...
                        <td width='125' height='13' align='center' valign='middle'>$data[id_pembayaran]</td>
                        ...
                        <td width='100' height='13' align='center' valign='middle'>$data[subtotal]</td>
                        <td width='50' height='13' align='center' valign='middle'>$data[jumlah_bayar]</td>
                        <td width='50' height='13' align='center' valign='middle'>$data[status]</td>
                    </tr>";
            $no++;
        }
        ?>  
