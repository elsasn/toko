...
/*Table structure for table `det_beli` */

DROP TABLE IF EXISTS `det_beli`;

CREATE TABLE `det_beli` (
  `id_det_beli` int(11) NOT NULL AUTO_INCREMENT,
  `id_pembelian` varchar(20) DEFAULT NULL,
  `id_produk` varchar(20) DEFAULT NULL,
  `jumlah` float DEFAULT NULL,
  PRIMARY KEY (`id_det_beli`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `det_beli` */
...
CREATE TABLE `diskon` (
  ...
  `id_diskon` varchar(20) DEFAULT NULL,
...
insert  into `kategori`(`id`,`id_kategori`,`nama`) values 
(1,'KTG-0001','SEPATU KULIT'),
(2,'KTG-0001','SEPATU RUNNING'),
(3,'KTG-0001','SEPATU BOLA'),
(4,'KTG-0001','SEPATU BASKET'),
(5,'KTG-0001','SEPATU CASUAL');
...
CREATE TABLE `ongkir` (
  ...
  `jenis_ongkir` enum('Standart','Express') DEFAULT NULL,
...
insert  into `produk`(`id`,`id_produk`,`nama`,`id_kategori`,`harga`,`stok`,`ket`,`gambar`) values 
(1,'PRDK-0001','Sepatu Casual.','KTG-0001',500000,'20','Sepatu Casual.','280720192109101.jpg'),
(2,'PRDK-0001','Sepatu Running.','KTG-0001',800000,'20','Sepatu Running.','280720192109334.jpg'),
(3,'PRDK-0001','Sepatu Biasa.','KTG-0001',100000000,'20','Sepatu Biasa.','280720192111027.jpg'),
(4,'PRDK-0001','Sepatu Kulit Asli.','KTG-0001',5000000,'20','Sepatu Kulit Asli.','280720192111469.jpg'),
(5,'PRDK-0001','Sepatu Kets.','KTG-0001',500000,'30','Sepatu Kets.','280720192112103.jpg');
